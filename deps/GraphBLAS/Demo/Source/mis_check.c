//------------------------------------------------------------------------------
// GraphBLAS/Demo/mis_check.c: maximal independent set, with error checking
//------------------------------------------------------------------------------
...
)
{
    ...
    while (nvals > 0)
    {
        ...
        OK (GrB_mxv (neighbor_max, candidates, NULL, maxSelect2nd,
            A, prob, r_desc)) ;
        ...
        OK (GrB_mxv (new_neighbors, candidates, NULL, Boolean, A,
            new_members, NULL)) ;
