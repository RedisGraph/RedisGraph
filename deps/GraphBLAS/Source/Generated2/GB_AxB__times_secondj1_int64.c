...
// A'*B (dot2):        GB (_Adot2B__times_secondj1_int64)
// A'*B (dot3):        GB (_Adot3B__times_secondj1_int64)
// C+=A'*B (dot4):     GB (_Adot4B__times_secondj1_int64)
// A*B (saxpy bitmap): GB (_AsaxbitB__times_secondj1_int64)
// A*B (saxpy3):       GB (_Asaxpy3B__times_secondj1_int64)
//     no mask:        GB (_Asaxpy3B_noM__times_secondj1_int64)
//     mask M:         GB (_Asaxpy3B_M__times_secondj1_int64)
//     mask !M:        GB (_Asaxpy3B_notM__times_secondj1_int64)
...
//------------------------------------------------------------------------------
    ...
    { 
        ...
        return (GrB_NO_VALUE) ;
        #else
        const int64_t cinput = (*((const int64_t *) cinput_void)) ;
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__times_secondj1_int64) (C,
