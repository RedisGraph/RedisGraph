...
// A+B function (eWiseAdd):         GB (_AaddB__isne_fc32)
// A.*B function (eWiseMult):       GB (_AemultB_08__isne_fc32)
// A.*B function (eWiseMult):       GB (_AemultB_02__isne_fc32)
// A.*B function (eWiseMult):       GB (_AemultB_04__isne_fc32)
// A.*B function (eWiseMult):       GB (_AemultB_bitmap__isne_fc32)
// A*D function (colscale):         GB ((none))
// D*A function (rowscale):         GB ((none))
// C+=B function (dense accum):     GB (_Cdense_accumB__isne_fc32)
// C+=b function (dense accum):     GB (_Cdense_accumb__isne_fc32)
// C+=A+B function (dense ewise3):  GB ((none))
// C=A+B function (dense ewise3):   GB (_Cdense_ewise3_noaccum__isne_fc32)
// C=scalar+B                       GB (_bind1st__isne_fc32)
// C=scalar+B'                      GB (_bind1st_tran__isne_fc32)
// C=A+scalar                       GB (_bind2nd__isne_fc32)
// C=A'+scalar                      GB (_bind2nd_tran__isne_fc32)
...
// BinaryOp:   cij = GB_FC32_isne (aij, bij)
...
#define GB_DISABLE \
    (GxB_NO_ISNE || GxB_NO_FC32 || GxB_NO_ISNE_FC32)
