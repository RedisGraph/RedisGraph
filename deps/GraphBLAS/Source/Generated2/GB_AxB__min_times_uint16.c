...
// A'*B (dot2):        GB (_Adot2B__min_times_uint16)
// A'*B (dot3):        GB (_Adot3B__min_times_uint16)
// C+=A'*B (dot4):     GB (_Adot4B__min_times_uint16)
// A*B (saxpy bitmap): GB (_AsaxbitB__min_times_uint16)
// A*B (saxpy3):       GB (_Asaxpy3B__min_times_uint16)
//     no mask:        GB (_Asaxpy3B_noM__min_times_uint16)
//     mask M:         GB (_Asaxpy3B_M__min_times_uint16)
//     mask !M:        GB (_Asaxpy3B_notM__min_times_uint16)
// A*B (saxpy4):       GB (_Asaxpy4B__min_times_uint16)
// A*B (saxpy5):       GB (_Asaxpy5B__min_times_uint16)
...
// MultAdd:  { uint16_t x_op_y = (x * y) ; z = GB_IMIN (z, x_op_y) ; }
