...
// A.*B function (eWiseMult):       GB (_AemultB__div_uint32)
// A.*B function (eWiseMult):       GB (_AemultB_02__div_uint32)
// A.*B function (eWiseMult):       GB (_AemultB_04__div_uint32)
...
// BinaryOp:   cij = GB_idiv_uint32 (aij, bij)
