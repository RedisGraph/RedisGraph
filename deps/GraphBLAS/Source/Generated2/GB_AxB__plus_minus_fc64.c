...
// A*B (saxpy4):       GB (_Asaxpy4B__plus_minus_fc64)
// A*B (saxpy5):       GB (_Asaxpy5B__plus_minus_fc64)
...
//    terminal?      0
//    terminal condition: ;
// MultAdd:  { GxB_FC64_t x_op_y = GB_FC64_minus (x, y) ; z = GB_FC64_add (z, x_op_y) ; }
