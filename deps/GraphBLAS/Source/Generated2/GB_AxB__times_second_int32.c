...
// A'*B (dot2):        GB (_Adot2B__times_second_int32)
// A'*B (dot3):        GB (_Adot3B__times_second_int32)
// C+=A'*B (dot4):     GB (_Adot4B__times_second_int32)
// A*B (saxpy bitmap): GB (_AsaxbitB__times_second_int32)
// A*B (saxpy3):       GB (_Asaxpy3B__times_second_int32)
//     no mask:        GB (_Asaxpy3B_noM__times_second_int32)
//     mask M:         GB (_Asaxpy3B_M__times_second_int32)
//     mask !M:        GB (_Asaxpy3B_notM__times_second_int32)
// A*B (saxpy4):       GB (_Asaxpy4B__times_second_int32)
// A*B (saxpy5):       GB (_Asaxpy5B__times_second_int32)
