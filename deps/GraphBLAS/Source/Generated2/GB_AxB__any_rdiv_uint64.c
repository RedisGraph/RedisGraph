...
// A'*B (dot2):        GB (_Adot2B__any_rdiv_uint64)
// A'*B (dot3):        GB (_Adot3B__any_rdiv_uint64)
// C+=A'*B (dot4):     GB (_Adot4B__any_rdiv_uint64)
// A*B (saxpy bitmap): GB (_AsaxbitB__any_rdiv_uint64)
// A*B (saxpy3):       GB (_Asaxpy3B__any_rdiv_uint64)
//     no mask:        GB (_Asaxpy3B_noM__any_rdiv_uint64)
//     mask M:         GB (_Asaxpy3B_M__any_rdiv_uint64)
//     mask !M:        GB (_Asaxpy3B_notM__any_rdiv_uint64)
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__any_rdiv_uint64) (C,
