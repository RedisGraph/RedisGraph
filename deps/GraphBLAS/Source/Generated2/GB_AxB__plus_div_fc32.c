...
// A'*B (dot2):        GB (_Adot2B__plus_div_fc32)
// A'*B (dot3):        GB (_Adot3B__plus_div_fc32)
// C+=A'*B (dot4):     GB (_Adot4B__plus_div_fc32)
// A*B (saxpy bitmap): GB (_AsaxbitB__plus_div_fc32)
// A*B (saxpy3):       GB (_Asaxpy3B__plus_div_fc32)
//     no mask:        GB (_Asaxpy3B_noM__plus_div_fc32)
//     mask M:         GB (_Asaxpy3B_M__plus_div_fc32)
//     mask !M:        GB (_Asaxpy3B_notM__plus_div_fc32)
...
//           atomic?        1
//           OpenMP atomic? 1
// MultAdd:  GxB_FC32_t x_op_y = GB_FC32_div (aik, bkj) ; cij = GB_FC32_add (cij, x_op_y)
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__plus_div_fc32) (C,
