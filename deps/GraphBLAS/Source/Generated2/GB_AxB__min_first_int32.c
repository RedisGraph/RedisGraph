...
// A'*B (dot2):        GB (_Adot2B__min_first_int32)
// A'*B (dot3):        GB (_Adot3B__min_first_int32)
// C+=A'*B (dot4):     GB (_Adot4B__min_first_int32)
// A*B (saxpy bitmap): GB (_AsaxbitB__min_first_int32)
// A*B (saxpy3):       GB (_Asaxpy3B__min_first_int32)
//     no mask:        GB (_Asaxpy3B_noM__min_first_int32)
//     mask M:         GB (_Asaxpy3B_M__min_first_int32)
//     mask !M:        GB (_Asaxpy3B_notM__min_first_int32)
// A*B (saxpy4):       GB (_Asaxpy4B__min_first_int32)
// A*B (saxpy5):       GB (_Asaxpy5B__min_first_int32)
...
// MultAdd:  { int32_t x_op_y = x ; z = GB_IMIN (z, x_op_y) ; }
