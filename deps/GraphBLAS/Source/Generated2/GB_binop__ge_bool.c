...
// A+B function (eWiseAdd):         GB (_AaddB__ge_bool)
// A.*B function (eWiseMult):       GB (_AemultB_01__ge_bool)
// A.*B function (eWiseMult):       GB (_AemultB_02__ge_bool)
// A.*B function (eWiseMult):       GB (_AemultB_03__ge_bool)
// A.*B function (eWiseMult):       GB (_AemultB_bitmap__ge_bool)
// A*D function (colscale):         GB (_AxD__ge_bool)
// D*A function (rowscale):         GB (_DxB__ge_bool)
// C+=B function (dense accum):     GB (_Cdense_accumB__ge_bool)
// C+=b function (dense accum):     GB (_Cdense_accumb__ge_bool)
// C+=A+B function (dense ewise3):  GB ((none))
// C=A+B function (dense ewise3):   GB (_Cdense_ewise3_noaccum__ge_bool)
// C=scalar+B                       GB (_bind1st__ge_bool)
// C=scalar+B'                      GB (_bind1st_tran__ge_bool)
// C=A+scalar                       GB (_bind2nd__ge_bool)
// C=A'+scalar                      GB (_bind2nd_tran__ge_bool)
