...
// A'*B (dot2):        GB (_Adot2B__max_min_uint16)
// A'*B (dot3):        GB (_Adot3B__max_min_uint16)
// C+=A'*B (dot4):     GB (_Adot4B__max_min_uint16)
// A*B (saxpy bitmap): GB (_AsaxbitB__max_min_uint16)
// A*B (saxpy3):       GB (_Asaxpy3B__max_min_uint16)
//     no mask:        GB (_Asaxpy3B_noM__max_min_uint16)
//     mask M:         GB (_Asaxpy3B_M__max_min_uint16)
//     mask !M:        GB (_Asaxpy3B_notM__max_min_uint16)
// A*B (saxpy4):       GB (_Asaxpy4B__max_min_uint16)
// A*B (saxpy5):       GB (_Asaxpy5B__max_min_uint16)
...
// MultAdd:  { uint16_t x_op_y = GB_IMIN (x, y) ; z = GB_IMAX (z, x_op_y) ; }
