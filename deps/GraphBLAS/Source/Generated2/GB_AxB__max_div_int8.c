...
// A*B (saxpy4):       GB (_Asaxpy4B__max_div_int8)
// A*B (saxpy5):       GB (_Asaxpy5B__max_div_int8)
...
// MultAdd:  { int8_t x_op_y = GB_idiv_int8 (x, y) ; z = GB_IMAX (z, x_op_y) ; }
...
#define GB_MULTADD(z, x, y, i, k, j) \
    { int8_t x_op_y = GB_idiv_int8 (x, y) ; z = GB_IMAX (z, x_op_y) ; }
