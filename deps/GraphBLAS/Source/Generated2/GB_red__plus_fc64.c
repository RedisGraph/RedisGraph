...
// Assemble tuples:    GB (_red_build__plus_fc64)
// Reduce to scalar:   GB (_red_scalar__plus_fc64)

// A type:   GxB_FC64_t
// C type:   GxB_FC64_t

// Reduce:   s = GB_FC64_add (s, aij)
