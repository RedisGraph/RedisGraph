...
// A'*B (dot2):        GB (_Adot2B__plus_lxor_uint64)
// A'*B (dot3):        GB (_Adot3B__plus_lxor_uint64)
// C+=A'*B (dot4):     GB (_Adot4B__plus_lxor_uint64)
// A*B (saxpy bitmap): GB (_AsaxbitB__plus_lxor_uint64)
// A*B (saxpy3):       GB (_Asaxpy3B__plus_lxor_uint64)
//     no mask:        GB (_Asaxpy3B_noM__plus_lxor_uint64)
//     mask M:         GB (_Asaxpy3B_M__plus_lxor_uint64)
//     mask !M:        GB (_Asaxpy3B_notM__plus_lxor_uint64)
// A*B (saxpy4):       GB (_Asaxpy4B__plus_lxor_uint64)
// A*B (saxpy5):       GB (_Asaxpy5B__plus_lxor_uint64)
