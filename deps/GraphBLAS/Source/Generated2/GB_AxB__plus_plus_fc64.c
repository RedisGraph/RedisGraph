...
// A'*B (dot2):        GB (_Adot2B__plus_plus_fc64)
// A'*B (dot3):        GB (_Adot3B__plus_plus_fc64)
// C+=A'*B (dot4):     GB (_Adot4B__plus_plus_fc64)
// A*B (saxpy bitmap): GB (_AsaxbitB__plus_plus_fc64)
// A*B (saxpy3):       GB (_Asaxpy3B__plus_plus_fc64)
//     no mask:        GB (_Asaxpy3B_noM__plus_plus_fc64)
//     mask M:         GB (_Asaxpy3B_M__plus_plus_fc64)
//     mask !M:        GB (_Asaxpy3B_notM__plus_plus_fc64)
...
//           atomic?        1
//           OpenMP atomic? 1
// MultAdd:  GxB_FC64_t x_op_y = GB_FC64_add (aik, bkj) ; cij = GB_FC64_add (cij, x_op_y)
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__plus_plus_fc64) (C,
