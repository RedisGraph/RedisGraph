...
//     no mask:        GB (_Asaxpy3B_noM__any_land_bool)
//     mask M:         GB (_Asaxpy3B_M__any_land_bool)
//     mask !M:        GB (_Asaxpy3B_notM__any_land_bool)
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__any_land_bool) (C,
