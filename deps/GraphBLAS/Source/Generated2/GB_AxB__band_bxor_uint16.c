...
// A'*B (dot2):        GB (_Adot2B__band_bxor_uint16)
// A'*B (dot3):        GB (_Adot3B__band_bxor_uint16)
// C+=A'*B (dot4):     GB (_Adot4B__band_bxor_uint16)
// A*B (saxpy bitmap): GB (_AsaxbitB__band_bxor_uint16)
// A*B (saxpy3):       GB (_Asaxpy3B__band_bxor_uint16)
//     no mask:        GB (_Asaxpy3B_noM__band_bxor_uint16)
//     mask M:         GB (_Asaxpy3B_M__band_bxor_uint16)
//     mask !M:        GB (_Asaxpy3B_notM__band_bxor_uint16)
// A*B (saxpy4):       GB (_Asaxpy4B__band_bxor_uint16)
// A*B (saxpy5):       GB (_Asaxpy5B__band_bxor_uint16)
