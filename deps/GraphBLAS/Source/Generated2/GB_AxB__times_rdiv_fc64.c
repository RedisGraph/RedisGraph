...
// A'*B (dot2):        GB (_Adot2B__times_rdiv_fc64)
// A'*B (dot3):        GB (_Adot3B__times_rdiv_fc64)
// C+=A'*B (dot4):     GB (_Adot4B__times_rdiv_fc64)
// A*B (saxpy bitmap): GB (_AsaxbitB__times_rdiv_fc64)
// A*B (saxpy3):       GB (_Asaxpy3B__times_rdiv_fc64)
//     no mask:        GB (_Asaxpy3B_noM__times_rdiv_fc64)
//     mask M:         GB (_Asaxpy3B_M__times_rdiv_fc64)
//     mask !M:        GB (_Asaxpy3B_notM__times_rdiv_fc64)

// C type:   GxB_FC64_t
// A type:   GxB_FC64_t
// B type:   GxB_FC64_t

// Multiply: z = GB_FC64_div (bkj, aik)
// Add:      cij = GB_FC64_mul (cij, z)
//           'any' monoid?  0
//           atomic?        0
//           OpenMP atomic? 0
// MultAdd:  GxB_FC64_t x_op_y = GB_FC64_div (bkj, aik) ; cij = GB_FC64_mul (cij, x_op_y)
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__times_rdiv_fc64) (C,
