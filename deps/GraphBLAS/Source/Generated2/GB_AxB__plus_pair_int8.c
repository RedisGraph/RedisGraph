...
// A'*B (dot2):        GB (_Adot2B__plus_pair_int8)
// A'*B (dot3):        GB (_Adot3B__plus_pair_int8)
// C+=A'*B (dot4):     GB (_Adot4B__plus_pair_int8)
// A*B (saxpy bitmap): GB (_AsaxbitB__plus_pair_int8)
// A*B (saxpy3):       GB (_Asaxpy3B__plus_pair_int8)
//     no mask:        GB (_Asaxpy3B_noM__plus_pair_int8)
//     mask M:         GB (_Asaxpy3B_M__plus_pair_int8)
//     mask !M:        GB (_Asaxpy3B_notM__plus_pair_int8)
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__plus_pair_int8) (C,
