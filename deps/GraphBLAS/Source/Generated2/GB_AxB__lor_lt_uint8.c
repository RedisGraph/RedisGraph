...
// A'*B (dot2):        GB (_Adot2B__lor_lt_uint8)
// A'*B (dot3):        GB (_Adot3B__lor_lt_uint8)
// C+=A'*B (dot4):     GB (_Adot4B__lor_lt_uint8)
// A*B (saxpy bitmap): GB (_AsaxbitB__lor_lt_uint8)
// A*B (saxpy3):       GB (_Asaxpy3B__lor_lt_uint8)
//     no mask:        GB (_Asaxpy3B_noM__lor_lt_uint8)
//     mask M:         GB (_Asaxpy3B_M__lor_lt_uint8)
//     mask !M:        GB (_Asaxpy3B_notM__lor_lt_uint8)
// A*B (saxpy4):       GB (_Asaxpy4B__lor_lt_uint8)
// A*B (saxpy5):       GB (_Asaxpy5B__lor_lt_uint8)
