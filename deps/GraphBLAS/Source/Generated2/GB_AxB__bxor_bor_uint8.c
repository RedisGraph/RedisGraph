...
// A'*B (dot2):        GB (_Adot2B__bxor_bor_uint8)
// A'*B (dot3):        GB (_Adot3B__bxor_bor_uint8)
// C+=A'*B (dot4):     GB (_Adot4B__bxor_bor_uint8)
// A*B (saxpy bitmap): GB (_AsaxbitB__bxor_bor_uint8)
// A*B (saxpy3):       GB (_Asaxpy3B__bxor_bor_uint8)
//     no mask:        GB (_Asaxpy3B_noM__bxor_bor_uint8)
//     mask M:         GB (_Asaxpy3B_M__bxor_bor_uint8)
//     mask !M:        GB (_Asaxpy3B_notM__bxor_bor_uint8)
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__bxor_bor_uint8) (C,
