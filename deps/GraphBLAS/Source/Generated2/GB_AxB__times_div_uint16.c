...
// A'*B (dot2):        GB (_Adot2B__times_div_uint16)
// A'*B (dot3):        GB (_Adot3B__times_div_uint16)
// C+=A'*B (dot4):     GB (_Adot4B__times_div_uint16)
// A*B (saxpy bitmap): GB (_AsaxbitB__times_div_uint16)
// A*B (saxpy3):       GB (_Asaxpy3B__times_div_uint16)
//     no mask:        GB (_Asaxpy3B_noM__times_div_uint16)
//     mask M:         GB (_Asaxpy3B_M__times_div_uint16)
//     mask !M:        GB (_Asaxpy3B_notM__times_div_uint16)
// A*B (saxpy4):       GB (_Asaxpy4B__times_div_uint16)
// A*B (saxpy5):       GB (_Asaxpy5B__times_div_uint16)
...
// MultAdd:  { uint16_t x_op_y = GB_idiv_uint16 (x, y) ; z *= x_op_y ; }
...
#define GB_MULTADD(z, x, y, i, k, j) \
    { uint16_t x_op_y = GB_idiv_uint16 (x, y) ; z *= x_op_y ; }
