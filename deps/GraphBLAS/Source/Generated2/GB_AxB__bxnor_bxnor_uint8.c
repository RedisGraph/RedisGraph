...
// A'*B (dot2):        GB (_Adot2B__bxnor_bxnor_uint8)
// A'*B (dot3):        GB (_Adot3B__bxnor_bxnor_uint8)
// C+=A'*B (dot4):     GB (_Adot4B__bxnor_bxnor_uint8)
// A*B (saxpy bitmap): GB (_AsaxbitB__bxnor_bxnor_uint8)
// A*B (saxpy3):       GB (_Asaxpy3B__bxnor_bxnor_uint8)
//     no mask:        GB (_Asaxpy3B_noM__bxnor_bxnor_uint8)
//     mask M:         GB (_Asaxpy3B_M__bxnor_bxnor_uint8)
//     mask !M:        GB (_Asaxpy3B_notM__bxnor_bxnor_uint8)
...
//           atomic?        1
//           OpenMP atomic? 0
// MultAdd:  uint8_t x_op_y = ~(aik ^ bkj) ; cij = ~(cij ^ x_op_y)
// Identity: 0xFF
// Terminal: ;
...
//------------------------------------------------------------------------------
    ...
    { 
        ...
        return (GrB_NO_VALUE) ;
        #else
        const uint8_t cinput = (*((const uint8_t *) cinput_void)) ;
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__bxnor_bxnor_uint8) (C,
