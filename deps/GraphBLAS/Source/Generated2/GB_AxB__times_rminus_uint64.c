...
// A'*B (dot2):        GB (_Adot2B__times_rminus_uint64)
// A'*B (dot3):        GB (_Adot3B__times_rminus_uint64)
// C+=A'*B (dot4):     GB (_Adot4B__times_rminus_uint64)
// A*B (saxpy bitmap): GB (_AsaxbitB__times_rminus_uint64)
// A*B (saxpy3):       GB (_Asaxpy3B__times_rminus_uint64)
//     no mask:        GB (_Asaxpy3B_noM__times_rminus_uint64)
//     mask M:         GB (_Asaxpy3B_M__times_rminus_uint64)
//     mask !M:        GB (_Asaxpy3B_notM__times_rminus_uint64)
// A*B (saxpy4):       GB (_Asaxpy4B__times_rminus_uint64)
// A*B (saxpy5):       GB (_Asaxpy5B__times_rminus_uint64)
...
// MultAdd:  { uint64_t x_op_y = (y - x) ; z *= x_op_y ; }
