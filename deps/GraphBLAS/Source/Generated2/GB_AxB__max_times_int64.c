...
// A'*B (dot2):        GB (_Adot2B__max_times_int64)
// A'*B (dot3):        GB (_Adot3B__max_times_int64)
// C+=A'*B (dot4):     GB (_Adot4B__max_times_int64)
// A*B (saxpy bitmap): GB (_AsaxbitB__max_times_int64)
// A*B (saxpy3):       GB (_Asaxpy3B__max_times_int64)
//     no mask:        GB (_Asaxpy3B_noM__max_times_int64)
//     mask M:         GB (_Asaxpy3B_M__max_times_int64)
//     mask !M:        GB (_Asaxpy3B_notM__max_times_int64)
// A*B (saxpy4):       GB (_Asaxpy4B__max_times_int64)
// A*B (saxpy5):       GB (_Asaxpy5B__max_times_int64)
...
// MultAdd:  { int64_t x_op_y = (x * y) ; z = GB_IMAX (z, x_op_y) ; }
