...
// A'*B (dot2):        GB (_Adot2B__any_secondj1_int32)
// A'*B (dot3):        GB (_Adot3B__any_secondj1_int32)
// C+=A'*B (dot4):     GB (_Adot4B__any_secondj1_int32)
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__any_secondj1_int32) (C,
