...
// A'*B (dot2):        GB (_Adot2B__any_plus_fp32)
// A'*B (dot3):        GB (_Adot3B__any_plus_fp32)
// C+=A'*B (dot4):     GB (_Adot4B__any_plus_fp32)
// A*B (saxpy bitmap): GB (_AsaxbitB__any_plus_fp32)
// A*B (saxpy3):       GB (_Asaxpy3B__any_plus_fp32)
//     no mask:        GB (_Asaxpy3B_noM__any_plus_fp32)
//     mask M:         GB (_Asaxpy3B_M__any_plus_fp32)
//     mask !M:        GB (_Asaxpy3B_notM__any_plus_fp32)
...
{ 
    ...
    {
        // C = A*B, no mask
        return (GB (_Asaxpy3B_noM__any_plus_fp32) (C,
