...
// functions:
// phase1: GB (_sel_phase1__nonzero_bool)
// phase2: GB (_sel_phase2__nonzero_bool)
// bitmap: GB (_sel_bitmap__nonzero_bool)
...
#define GB_SELECT_ENTRY(Cx,pC,Ax,pA)                    \
    /* assignment skipped, C is iso with all entries true */
