...
// functions:
// phase1: GB (_sel_phase1__eq_thunk_fc32)
// phase2: GB (_sel_phase2__eq_thunk_fc32)
// bitmap: GB (_sel_bitmap__eq_thunk_fc32)
...
#define GB_TEST_VALUE_OF_ENTRY(keep,p)                  \
    bool keep = GB_FC32_eq (Ax [p], thunk)
