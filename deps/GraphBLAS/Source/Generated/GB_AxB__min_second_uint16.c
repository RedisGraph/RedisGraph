...
// A'*B function (dot):      GB_AdotB__min_second_uint16
...
// Identity: UINT16_MAX (where cij = GB_IMIN (cij,identity) does not change cij)
// Multiply: z = y
...
{ 
    ...
    uint16_t *restrict Sauna_Work = Sauna->Sauna_Work ;  // size C->vlen*zsize
