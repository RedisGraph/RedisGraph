//------------------------------------------------------------------------------
// GB_AxB__times_second_int8:  hard-coded C=A*B
//------------------------------------------------------------------------------
...
// A*B function:  GB_AxB__times_second_int8
// A'*B function: GB_AdotB__times_second_int8
...
void GB_AxB__times_second_int8
(
    GrB_Matrix C,
...
void GB_AdotB__times_second_int8
(
    GrB_Matrix C,
    const GrB_Matrix Mask,
    const GrB_Matrix A,
