...
// phase1: GB_sel_phase1__eq_zero_any
// phase2: GB_sel_phase2__eq_zero_any

// A type:   GB_void
// selectop: (!GB_is_nonzero (Ax +((p)*asize), asize))
