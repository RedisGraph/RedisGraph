//------------------------------------------------------------------------------
// GB_AxB__min_div_int16:  hard-coded C=A*B
//------------------------------------------------------------------------------
...
// A*B function:  GB_AxB__min_div_int16
// A'*B function: GB_AdotB__min_div_int16
// Z type :  int16_t (the type of C)
// XY type:  int16_t (the type of A and B)
// Identity: INT16_MAX (where cij = IMIN (cij,INT16_MAX) does not change cij)
