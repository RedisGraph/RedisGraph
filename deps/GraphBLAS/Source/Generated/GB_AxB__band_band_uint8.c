...
// A'*B function (dot2):     GB_Adot2B__band_band_uint8
// A'*B function (dot3):     GB_Adot3B__band_band_uint8
// C+=A'*B function (dot4):  GB_Adot4B__band_band_uint8
// A*B function (saxpy3):    GB_Asaxpy3B__band_band_uint8
...
GrB_Info GB_Adot4B__band_band_uint8
(
    GrB_Matrix C,
    const GrB_Matrix A, bool A_is_pattern,
