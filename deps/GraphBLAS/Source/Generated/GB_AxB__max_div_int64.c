//------------------------------------------------------------------------------
// GB_AxB__max_div_int64:  hard-coded C=A*B
//------------------------------------------------------------------------------
...
// A*B function:  GB_AxB__max_div_int64
// A'*B function: GB_AdotB__max_div_int64
// Z type :  int64_t (the type of C)
// XY type:  int64_t (the type of A and B)
// Identity: INT64_MIN (where cij = IMAX (cij,INT64_MIN) does not change cij)
