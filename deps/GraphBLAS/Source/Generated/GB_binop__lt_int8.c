...
// C+=B function (dense accum):     GB_Cdense_accumB__lt_int8
// C+=b function (dense accum):     GB_Cdense_accumb__lt_int8
// C+=A+B function (dense ewise3):  (none)
// C=A+B function (dense ewise3):   GB_Cdense_ewise3_noaccum__lt_int8
// C=scalar+B                       GB_bind1st__lt_int8
// C=scalar+B'                      GB_bind1st_tran__lt_int8
// C=A+scalar                       GB_bind2nd__lt_int8
// C=A'+scalar                      GB_bind2nd_tran__lt_int8
