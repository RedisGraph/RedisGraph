//------------------------------------------------------------------------------
// GB_AxB__max_div_uint64:  hard-coded C=A*B
//------------------------------------------------------------------------------
...
// A*B function:  GB_AxB__max_div_uint64
// A'*B function: GB_AdotB__max_div_uint64
// Z type :  uint64_t (the type of C)
// XY type:  uint64_t (the type of A and B)
// Identity: 0 (where cij = IMAX (cij,0) does not change cij)
