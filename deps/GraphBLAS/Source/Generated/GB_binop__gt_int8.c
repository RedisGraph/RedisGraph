...
// C+=B function (dense accum):     GB_Cdense_accumB__gt_int8
// C+=b function (dense accum):     GB_Cdense_accumb__gt_int8
// C+=A+B function (dense ewise3):  (none)
// C=A+B function (dense ewise3):   GB_Cdense_ewise3_noaccum__gt_int8
// C=scalar+B                       GB_bind1st__gt_int8
// C=scalar+B'                      GB_bind1st_tran__gt_int8
// C=A+scalar                       GB_bind2nd__gt_int8
// C=A'+scalar                      GB_bind2nd_tran__gt_int8
