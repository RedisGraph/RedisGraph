//------------------------------------------------------------------------------
// GB_AxB__min_div_int8:  hard-coded C=A*B
//------------------------------------------------------------------------------
...
// A*B function:  GB_AxB__min_div_int8
// A'*B function: GB_AdotB__min_div_int8
// Z type :  int8_t (the type of C)
// XY type:  int8_t (the type of A and B)
// Identity: INT8_MAX (where cij = IMIN (cij,INT8_MAX) does not change cij)
