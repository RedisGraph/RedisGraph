...
// A'*B function (dot):      GB_AdotB__max_second_int64
...
// Identity: INT64_MIN (where cij = GB_IMAX (cij,identity) does not change cij)
// Multiply: z = y
...
{ 
    ...
    int64_t *restrict Sauna_Work = Sauna->Sauna_Work ;  // size C->vlen*zsize
