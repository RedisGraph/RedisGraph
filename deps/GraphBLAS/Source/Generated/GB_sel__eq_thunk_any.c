...
// phase1: GB_sel_phase1__eq_thunk_any
// phase2: GB_sel_phase2__eq_thunk_any

// A type:   GB_void
// selectop: (memcmp (Ax +((p)*asize), xthunk, asize) == 0)
...
#define GB_SELECT_ENTRY(Cx,pC,Ax,pA)                    \
    memcpy (Cx +((pC)*asize), xthunk, asize)
