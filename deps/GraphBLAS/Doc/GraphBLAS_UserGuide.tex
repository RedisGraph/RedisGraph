...
%----------------------------------------
\subsection{More details on the Mac (Intel-based)}
%----------------------------------------
...
\item The ninja code generator does not work with MS Visual Studio to
build GraphBLAS, because of a limitation in cmake.
\end{itemize}
