...
SuiteSparse/GraphBLAS folder.

    {\small
    \begin{verbatim}
    cmake .  \end{verbatim} }

\item Open the generated \verb'GraphBLAS.sln' file in Visual Studio.
Alternatively, type this command in the terminal window:
    ...
    This should create a folder called \verb'Release' and place the
    compiled DLL and LIB file there.

\item Move the DLL and LIB files from the \verb'Release' folder
    to the \verb'GraphBLAS/build' folder.

\item Add the \verb'GraphBLAS/build' folder to the Windows System path.
