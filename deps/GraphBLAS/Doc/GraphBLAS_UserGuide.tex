...
To sort the columns, use \verb'GrB_DESC_IN0'.  A comparator operator is
...
\verb'A' must also match exactly (even with the \verb'GrB_DESC_IN0'
descriptor).
...
version (\verb'/usr/local/lib/libgraphblas.so.5.2.0' for example):
