...
)
{
    ...
    #elif defined (GxB_GBTL_GRAPHBLAS)
        // Other libraries can add similar library-specific tests, if
        // available, and modify the csr flag accordingly.  If both A and AT
        // are provided, they must have the same format.
    #elif defined (GxB_GUNROCK_GRAPHBLAS)
        // ...
    #elif defined (GxB_IBM_GRAPHBLAS)
        // ...
    #endif
