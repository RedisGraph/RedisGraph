...
%
% With a single output, only the statistics on all k-trusses of A are returned:
%
...
% are empty.  C{3} to C{kmax} are the 3-truss to kmax-truss of A.  See
% LAGraph/Test/KTrusss/ktruss.m for a description of each k-truss. The
% kmax-truss is empty, with k=kmax being the smallest k for which the k-truss
% is empty.
