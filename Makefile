...
LIBS=$(RAX) $(HDR_HISTOGRAM) $(LIBXXHASH) $(GRAPHBLAS) $(REDISEARCH_LIBS) $(LIBCYPHER_PARSER)
...
deps: $(LIBCYPHER_PARSER) $(HDR_HISTOGRAM) $(GRAPHBLAS) $(LIBXXHASH) $(RAX) $(REDISEARCH_LIBS)
