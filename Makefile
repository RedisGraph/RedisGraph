...
LIBS=$(RAX) $(HDR_HISTOGRAM_LIBS) $(LIBXXHASH) $(GRAPHBLAS) $(REDISEARCH_LIBS) $(LIBCYPHER_PARSER)
...
DEPENDENCIES=libcypher-parser graphblas redisearch hdr_histogram rax libxxhash
...
deps: $(LIBCYPHER_PARSER) $(HDR_HISTOGRAM_LIBS) $(GRAPHBLAS) $(LIBXXHASH) $(RAX) $(REDISEARCH_LIBS)
...
.PHONY: libcypher-parser graphblas redisearch libxxhash rax hdr_histogram
