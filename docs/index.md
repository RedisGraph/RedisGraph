...
```sh
GRAPH.CREATENODE us_government presidents name "Barack Obama" age 55
```
...
The `movie` destination node is of "type" movie.
...
Here we're interested to find out who are my friends' friends.
