...
```sh
[ [alias][:types]*[minLen][..[maxLen]][{prop:val[,prop:val ...]}] ]
```
...
- `{prop:val[,prop:val ...]}` are optional property value equality constraints that apply to all relationships in the path.
