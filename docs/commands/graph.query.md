...
<br> distFuncParams, if specified, should be a map. It may contain scaleFactor - a floating-point value [0 .. 0.25] (default value: 0.1) <br> Returns null when str1 evaluates to null <br> Returns null when str2 evaluates to null                                                                        |
&#42; RedisGraph-specific extensions to Cypher
