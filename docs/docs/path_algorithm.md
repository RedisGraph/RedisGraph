...
RedisGraph 2.10 introduced two new path-finding algorithms, or more accurately, minimal-weight, optionally bounded-cost, and optionally bounded-length path-finding algorithms, `algo.SPpaths` and `algo.SSpaths`.
