...
TEST_F(TraversalOrderingTest, TransposeFree) {
	...
	AlgebraicExpression *ExpAB = AlgebraicExpression_NewOperand(GrB_NULL, false, false, "A", "B", NULL);
	AlgebraicExpression *ExpBC = AlgebraicExpression_NewOperand(GrB_NULL, false, false, "B", "C", NULL);
	AlgebraicExpression *ExpCD = AlgebraicExpression_NewOperand(GrB_NULL, false, false, "C", "D", NULL);
