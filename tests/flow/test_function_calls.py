...
class testFunctionCallsFlow(FlowTestsBase):
    ...
    def test58_Round(self):
        query_to_expected_result = {
            ...
            "RETURN ROUND(-3.141, 2)": [[-3.14]],
            "RETURN ROUND(1.1746, 3)": [[1.175]],
            "RETURN ROUND(-1.1746, 3)": [[-1.175]],
            "RETURN ROUND(2.3875, 3)": [[2.388]],
            "RETURN ROUND(-2.3875, 3)": [[-2.388]],
            "RETURN ROUND(1.142, 2, 'CEILING')": [[1.15]],
            "RETURN ROUND(-1.142, 2, 'CEILING')": [[-1.14]],
            "RETURN ROUND(3.745, 2, 'CEILING')": [[3.75]],
            "RETURN ROUND(-3.745, 2, 'CEILING')": [[-3.74]],
            "RETURN ROUND(3.748, 2, 'CEILING')": [[3.75]],
            "RETURN ROUND(-3.748, 2, 'CEILING')": [[-3.74]],
            "RETURN ROUND(1.142, 2, 'FLOOR')": [[1.14]],
            "RETURN ROUND(-1.142, 2, 'FLOOR')": [[-1.15]],
            "RETURN ROUND(3.745, 2, 'FLOOR')": [[3.74]],
            "RETURN ROUND(-3.745, 2, 'FLOOR')": [[-3.75]],
            "RETURN ROUND(3.748, 2, 'FLOOR')": [[3.74]],
            "RETURN ROUND(-3.748, 2, 'FLOOR')": [[-3.75]],
            "RETURN ROUND(1.142, 2, 'AWAY_FROM_ZERO')": [[1.15]],
            "RETURN ROUND(-1.142, 2, 'AWAY_FROM_ZERO')": [[-1.15]],
            "RETURN ROUND(3.745, 2, 'AWAY_FROM_ZERO')": [[3.75]],
            "RETURN ROUND(-3.745, 2, 'AWAY_FROM_ZERO')": [[-3.75]],
            "RETURN ROUND(3.748, 2, 'AWAY_FROM_ZERO')": [[3.75]],
            "RETURN ROUND(-3.748, 2, 'AWAY_FROM_ZERO')": [[-3.75]],
            "RETURN ROUND(1.142, 2, 'TOWARD_ZERO')": [[1.14]],
            "RETURN ROUND(-1.142, 2, 'TOWARD_ZERO')": [[-1.14]],
            "RETURN ROUND(3.745, 2, 'TOWARD_ZERO')": [[3.74]],
            "RETURN ROUND(-3.745, 2, 'TOWARD_ZERO')": [[-3.74]],
            "RETURN ROUND(3.748, 2, 'TOWARD_ZERO')": [[3.74]],
            "RETURN ROUND(-3.748, 2, 'TOWARD_ZERO')": [[-3.74]],
            "RETURN ROUND(1.142, 2, 'HALF_UP')": [[1.14]],
            "RETURN ROUND(-1.142, 2, 'HALF_UP')": [[-1.14]],
            "RETURN ROUND(3.745, 2, 'HALF_UP')": [[3.75]],
            "RETURN ROUND(-3.745, 2, 'HALF_UP')": [[-3.75]],
            "RETURN ROUND(3.748, 2, 'HALF_UP')": [[3.75]],
            "RETURN ROUND(-3.748, 2, 'HALF_UP')": [[-3.75]],
            "RETURN ROUND(1.142, 2, 'HALF_DOWN')": [[1.14]],
            "RETURN ROUND(-1.142, 2, 'HALF_DOWN')": [[-1.14]],
            "RETURN ROUND(3.745, 2, 'HALF_DOWN')": [[3.74]],
            "RETURN ROUND(-3.745, 2, 'HALF_DOWN')": [[-3.74]],
            "RETURN ROUND(3.748, 2, 'HALF_DOWN')": [[3.75]],
            "RETURN ROUND(-3.748, 2, 'HALF_DOWN')": [[-3.75]],
            "RETURN ROUND(1.142, 2, 'HALF_EVEN')": [[1.14]],
            "RETURN ROUND(-1.142, 2, 'HALF_EVEN')": [[-1.14]],
