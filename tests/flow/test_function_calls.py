...
class testFunctionCallsFlow(FlowTestsBase):
    ...
    def test46_NullArithmetic(self):
        query_to_expected_result = {
            "RETURN null + 1": [[None]],
            "RETURN 1 + null": [[None]],
            "RETURN null - 1": [[None]],
    ...
    def test77_division_inputs(self):
    ...
    def test78_type_mismatch_message(self):
