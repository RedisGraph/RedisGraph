...
class testFunctionCallsFlow(FlowTestsBase):
    ...
    def test17_to_json(self):
        ...
        query = """MATCH (n) WITH collect(n) AS all_n match ()-[r:works_with]->() WITH all_n, collect(r) AS all_r RETURN toJSON(all_n + all_r, false)"""
        actual_result = graph.query(query)
        expected = [{'type': 'node', 'id': 0, 'labels': ['person'], 'properties': {'name': 'Roi', 'val': 0}}, {'type': 'node', 'id': 1, 'labels': ['person', 'student'], 'properties': {'name': 'Alon', 'val': 1}}, {'type': 'node', 'id': 2, 'labels': ['person'], 'properties': {'name': 'Ailon', 'val': 2}}, {'type': 'node', 'id': 3, 'labels': ['person', 'student'], 'properties': {'name': 'Boaz', 'val': 3}}, {'type': 'relationship', 'id': 12, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 0}, 'end': {'id': 1}}, {'type': 'relationship', 'id': 13, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 0}, 'end': {'id': 2}}, {'type': 'relationship', 'id': 14, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 0}, 'end': {'id': 3}}, {'type': 'relationship', 'id': 15, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 1}, 'end': {'id': 0}}, {'type': 'relationship', 'id': 16, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 1}, 'end': {'id': 2}}, {'type': 'relationship', 'id': 17, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 1}, 'end': {'id': 3}}, {'type': 'relationship', 'id': 18, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 2}, 'end': {'id': 0}}, {'type': 'relationship', 'id': 19, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 2}, 'end': {'id': 1}}, {'type': 'relationship', 'id': 20, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 2}, 'end': {'id': 3}}, {'type': 'relationship', 'id': 21, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 3}, 'end': {'id': 0}}, {'type': 'relationship', 'id': 22, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 3}, 'end': {'id': 1}}, {'type': 'relationship', 'id': 23, 'relationship': 'works_with', 'properties': {}, 'start': {'id': 3}, 'end': {'id': 2}}]
        parsed = json.loads(actual_result.result_set[0][0])
        self.env.assertEquals(parsed, expected)
