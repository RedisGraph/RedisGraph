...
#define RG_TEMPORAL_FUNC_SUCCESS INT64_MAX
...
/**
  ...
  * @retval year in the range [-999,999,999:999,999,999] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   TIME, LOCAL_TIME and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval quater in the range [1:4] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   TIME, LOCAL_TIME and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval month in the range [1:12] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   TIME, LOCAL_TIME and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval year in the range [1:53] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   TIME, LOCAL_TIME and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval day in the range [1:92] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   TIME, LOCAL_TIME and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval day in the range [1:31] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   TIME, LOCAL_TIME and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval day in the range [1:366] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   TIME, LOCAL_TIME and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval day in the range [1:7] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @param  temporalValue: relevant temporal value
  * @retval hour in the range [0:23] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   DATE and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval minute in the range [0:59] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   DATE and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval second in the range [0:60] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   DATE and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval millisecond in the range [0:999] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   DATE and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval microsecond in the range [0:999,999] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  ...
  * @note   DATE and DURATION values are not supported
  * @param  temporalValue: relevant temporal value
  * @retval nanosecond in the range [0:999,999,999] for relevant values. RG_TEMPORAL_FUNC_FAIL otherwise
  */
int64_t RG_TemporalValue_GetNanosecond(RG_TemporalValue temporalValue);

/**
  * @brief  returns a pointer to the timezone string of a supported temporal value
  * @note   supported only for datetime and time
  * @param  temporalValue:
  * @param  *str: out-by-pointer
  * @retval RG_TEMPORAL_FUNC_SUCCESS for relevant types, RG_TEMPORAL_FUNC_FAIL otherwise
  */
...
/**
  * @brief  returns if there is support for time zone in this type
  * @note   supported in datetime and time
  * @param  temporalValue:
  * @retval true for datetime and time, false otherwise
  */
