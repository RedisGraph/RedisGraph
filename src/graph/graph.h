...
#define GRAPH_MINIMUM_NODE_CAP 128              // Minimum capacity for node count a graph can hold before resizing.
#define GRAPH_MINIMUM_EDGE_CAP 128              // Minimum capacity for node count a graph can hold before resizing.
