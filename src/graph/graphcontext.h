...
// increase GraphContext reference count by one
void GraphContext_IncreaseRefCount(GraphContext *gc);

// decrease GraphContext reference count by one
void GraphContext_DecreaseRefCount(GraphContext *gc);
