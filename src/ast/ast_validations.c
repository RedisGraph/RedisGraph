...
// Verify that MERGE doesn't redeclare bound relations
// and that one reltype is specified for unbound relations.
...
(
	...
	// remove identifier from env if it was introduced from the list comprehension
	if(is_new) {
