...
typedef struct {
	...
	Record *matched_records;          // Records found by this operation and to be emitted.
	Record *created_records;          // Records which created by this operation and to be emitted.
