...
OpBase* NewDeleteOp(RedisModuleCtx *ctx, AST_DeleteNode *ast_delete_node, QueryGraph *graph, const char *graph_name, ResultSet *result_set);
OpDelete* _NewDeleteOp(RedisModuleCtx *ctx, AST_DeleteNode *ast_delete_node, QueryGraph *graph, const char *graph_name, ResultSet *result_set);
