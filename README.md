...
### Sample Builds Using Docker

See [here](docs/dockersamples/README.md) for instructions and sample dockers, that illustrate how to build RedisGraph on a variety of operating system segments.
